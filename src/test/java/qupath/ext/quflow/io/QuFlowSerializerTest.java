...
import qupath.ext.quflow.model.QualityFilter;
...
class QuFlowSerializerTest {
    ...
    void saveAndLoadRoundTrip() throws IOException {
        ...
        QuFlowSerializer.save(tree, file);
        GateTree loaded = QuFlowSerializer.load(file);
    ...
    void futureVersionThrowsIOException() throws IOException {
        ...
        assertThrows(IOException.class, () -> QuFlowSerializer.load(file));
    }
}
